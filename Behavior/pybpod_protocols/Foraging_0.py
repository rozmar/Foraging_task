...
setupname = 'Tower-2' #'Tower-3'#'Tower-2' #
protocolname = 'Foraging - Bari Cohen'#'Delayed foraging' #'Foraging - Bari Cohen'
...
if protocolname == 'Foraging - Bari Cohen':
    variables = { # Cohen
...
elif protocolname == 'Delayed foraging':
    variables = { # Delayed
